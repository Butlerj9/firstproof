...
| P07 | Lattices in Lie groups | ✅ Submitted | HIGH (YES, Q-PD via Shapiro + surgery) | ~4/80 msgs |
| P08 | Symplectic geometry | ✅ Submitted | HIGH (NO, Lagrangian octahedron counterexample) | ~8/80 msgs |
